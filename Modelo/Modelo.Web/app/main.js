    ...
    app.config(function ($stateProvider, $urlRouterProvider, $mdDateLocaleProvider, $mdThemingProvider) {
        ...
        $stateProvider
            ...
            .state('main.BoletimCRULF', {
             ...
             .state('main.BoletimUtilidades_Agua_Esgoto', {
                 url: "/BoletimUtilidadesAguaEsgoto",
                 templateUrl: "views/BoletimUtilidades_Agua_Esgoto.html",
                 controller: "BoletimUtilidades_Agua_EsgotoCtrl",
                 controllerAs: "ctrlAp",
                 menu: "Utilidades - Água e Esgoto",
                 icon: "toc",
                 nomeTela: "Utilidades - Água e Esgoto",
                 svg: false,
             })
