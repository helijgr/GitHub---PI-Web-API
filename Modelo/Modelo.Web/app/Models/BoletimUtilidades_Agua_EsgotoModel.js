...
(function () {
    ...
    angular.module("app.web").factory("BoletimUtilidades_Agua_EsgotoModel", BoletimUtilidades_Agua_EsgotoModel);

    function BoletimUtilidades_Agua_EsgotoModel(BoletimUtilidades_Agua_EsgotoService, $q) {
        /*
         * Atributos privados.
         */
